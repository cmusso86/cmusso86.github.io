---
title: "Qual o tamanho da sua incerteza?"
subtitle: "Pacote _recalibratiNN_"
author:
  - name: Carolina Musso 
    affiliations: "LatinR 2024"

title-slide-attributes:
    data-background-image: imgs/recalibratiNN.png
    data-background-size: 25%
    data-background-position: 70% 80%
...
$$
E então ajustamos um modelo de regressão linear simples...
...
n <- 10000 # numero de observações
split <- 0.8 # proporção para o treino
...
# Novas observações ou o conjunto de teste.
x_new <- runif(n/5, 1, 10)

# Ajustando um modelo de regressão linear simples
# que sabemos de antemão que não capturará a heterocedasticidade
model <- lm(y_train ~ x_train)

# predições e mse do conjunto de calibração
...
**Método:**
  ...
  -   [Torres et al (2024)](https://doi.org/10.48550/arXiv.2403.05756): Calibração local para regressões e em diversas representações do espaço de covariáveis: útil para Redes Neurais Artificiais (RNAs).
...
-   No [GitHub](https://github.com/cmusso86/recalibratiNN.git) 

- No [CRAN](https://doi.org/10.32614/CRAN.package.recalibratiNN)
...
[GitHub](https://github.com/cmusso86/LatinR2024.git)
