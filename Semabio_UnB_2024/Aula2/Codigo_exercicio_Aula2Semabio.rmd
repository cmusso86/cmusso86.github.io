...
media_virginica <- iris_media_area[iris_media_area$Species=="virginica", "area_media"]

iris_media_area |> 
  filter(Species == "virginica") |> 
  select(area_media)

media_setosa <- iris_media_area[iris_media_area$Species=="setosa", "area_media"] 

media_versicolor <- iris_media_area[iris_media_area$Species=="versicolor", "area_media"] 
